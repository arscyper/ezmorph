...
public abstract class AbstractObjectMorpherTestCase extends TestCase {
    ...
    public void testEquals_another_Morpher() {
        TestCase.assertFalse(getMorpherWithDefaultValue().equals(getAnotherMorpherWithDefaultValue()));
        TestCase.assertTrue(getMorpher().equals(getAnotherMorpher()));
    }

    public void testEquals_different_morpher() {
        TestCase.assertFalse(getMorpher().equals(new Morpher() {
